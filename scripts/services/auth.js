...
app.factory('Auth', function($firebase, $firebaseAuth, FURL) {
  ...
  var Auth = {
    ...
    createProfile : function(user, uid) {
      var profile = {
        name: user.name,
        email: user.email,
        gravatar: getGravatar(user.email, 40)
      };
    ...
    register: function(user) {
      return auth.$createUser({
        ...
        return Auth.createProfile(user, data.uid);
      })
    },
